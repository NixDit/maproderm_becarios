@extends('pages.home')
@section('toolbar_title','Ejemplo de página')
@section('toolbar_subtitle','Página de ejemplo de prueba')
@section('toolbar_actions')
    <button class="btn btn-sm btn-primary">Botón de ejemplo</button>
@endsection
@section('container')
    <!--begin::Row-->
