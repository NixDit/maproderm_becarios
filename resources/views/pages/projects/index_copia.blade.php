...
@section('container')
    ...
    <div class="row gy-5 g-xl-8">
        ...
        <!-- TODO: FIN SALES STATICS -->
        <!--end::Col-->
        <!--begin::Col-->
        <!-- TODO: INICIO ACTIVITIES -->
        {{-- <div class="col-xl-4">
            <!--begin::List Widget 5-->
            <div class="card card-xl-stretch">
                <!--begin::Header-->
