<div id="kt_header" style="" class="header align-items-stretch">
    ...
    <div class="container-fluid d-flex align-items-stretch justify-content-between">
        ...
        <div class="d-flex align-items-stretch justify-content-between flex-lg-grow-1">
            <!--begin::Navbar-->
            <!--TODO: Inicio de Cambios de botones, Dashboard y boton del formulario -->
            ...
            <!--TODO: Fin de Cambios de botones, Dashboard y boton del formulario -->
            <!--end::Navbar-->
            <!--begin::Topbar-->
            <div class="d-flex align-items-stretch flex-shrink-0">
                ...
                <div class="d-flex align-items-stretch flex-shrink-0">
                    ...
                    <!--end::Search-->
                    <!--begin::Activities-->
                    <!-- TODO: Empieza un boton de actividades -->
                    ...
                    <!-- TODO: Termina el boton de actividades -->
                    <!--end::Activities-->
                    <!--begin::Notifications-->
                    <!-- TODO: Empieza un boton de notificaciones -->
                    {{-- <div class="d-flex align-items-center ms-1 ms-lg-3">
                        <!--begin::Menu- wrapper-->
                    ...
                    <!-- TODO: Termina el boton de chat -->
                    <!--end::Chat-->
                    <!--begin::Quick links-->
                    <!-- TODO: Empieza un boton -->
                    {{-- <div class="d-flex align-items-center ms-1 ms-lg-3">
                        <!--begin::Menu wrapper-->
                        ...
                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-275px" data-kt-menu="true">
                            ...
                            <div class="menu-item px-3">
                                <div class="menu-content d-flex align-items-center px-3">
                                    ...
                                    <!--begin::Username-->
                                    <div class="d-flex flex-column">
                                        <div class="fw-bolder d-flex align-items-center fs-5">MaProDerm
                                        <span class="badge badge-light-success fw-bolder fs-8 px-2 py-1 ms-2">Pro</span></div>
                                        <a href="#" class="fw-bold text-muted text-hover-primary fs-7">contacto@maproderm.com</a>
                                    </div>
                                    <!--end::Username-->
                                </div>
                            </div>
                            ...
                            <div class="menu-item px-5" data-kt-menu-trigger="hover" data-kt-menu-placement="left-start">
                                ...
                                <div class="menu-sub menu-sub-dropdown w-175px py-4">
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-3">
                                        <a href="https://www.facebook.com/maproderm" class="menu-link px-5">MaProDerm</a>
                                    </div>
                                    <!--end::Menu item-->
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-3">
                                        <a href="https://www.facebook.com/groups/1816286932034513" class="menu-link px-5">Membresía</a>
                                    </div>
                                    <!--end::Menu item-->
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-3">
                                        <a href="https://www.instagram.com/maproderm/" class="menu-link px-5">Instagram</a>
                                    </div>
                                    <!--end::Menu item-->
                                    <!--begin::Menu item-->
                                    <!--begin::Menu separator-->
                            ...
                            <div class="menu-item px-5" data-kt-menu-trigger="hover" data-kt-menu-placement="left-start">
                                <a href="#" class="menu-link px-5">
                                    <span class="menu-title position-relative">Lenguajes
                                    <span class="fs-8 rounded bg-light px-3 py-2 position-absolute translate-middle-y top-50 end-0">Español
                                    <img class="w-15px h-15px rounded-1 ms-2" src="assets/media/flags/mexico.svg" alt="" /></span></span>
                                </a>
                                <!--begin::Menu sub-->
                                <div class="menu-sub menu-sub-dropdown w-175px py-4">
                                    <!--begin::Menu item-->
                            ...
                            <div class="menu-item px-5 my-1">
                                <a href="../../demo1/dist/account/settings.html" class="menu-link px-5">Configuración</a>
                            </div>
                            <!--end::Menu item-->
                            <!--begin::Menu item-->
                            <div class="menu-item px-5">
                                <a href="../../demo1/dist/authentication/flows/basic/sign-in.html" class="menu-link px-5">Cerrar sesión</a>
                            </div>
                            <!--end::Menu item-->
                            <!--begin::Menu separator-->
                            <div class="separator my-2"></div>
